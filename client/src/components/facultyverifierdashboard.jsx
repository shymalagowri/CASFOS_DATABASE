  ...
  return (
    <div className="dashboard-container">
      ...
      <Helmet>
        ...
        <title>CASFOS - Faculty Verifier Dashboard</title>
      </Helmet>
        ...
        <main className="main-content">
          ...
          <section className="hero-section">
            ...
            <div className="hero-content">
              <br />
              <br />
              <p>Central Academy for State Forest Service - Faculty Verifier Dashboard</p>
            </div>
          </section>
            ...
            <div className="section-container">
              ...
              <div className="about-content">
                <div className="about-text">
                  <p>
                    The Central Academy for State Forest Service, Coimbatore (CASFOS) is a premier institution under the Directorate of Forest Education, Ministry of Environment, Forests, and Climate Change. It trains Range Forest Officers and State Forest Service Officers.
                  </p>
                  <p>
                    The Faculty Verifier ensures the accuracy and integrity of faculty data, verifying details to support training programs. Established in 1980, CASFOS remains a leader in forestry education.
                  </p>
                </div>
