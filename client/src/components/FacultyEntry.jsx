 ...
 * facultyentry.jsx
 *
 * This React component provides a comprehensive form and workflow for entering, editing, and submitting faculty details
 * in the CASFOS Faculty Management System. It supports internal, external, and contract faculty types, allowing users to:
 *   - Enter and validate detailed personal, professional, and academic information for faculty members.
 *   - Manage dynamic fields for domain expertise, education, publications, courses, modules, and responsibilities.
 *   - Upload and preview faculty photographs with file size validation.
 *   - Auto-save draft data periodically and restore drafts on reload.
 *   - Edit and resubmit previously rejected faculty entries.
 *   - Integrate with backend APIs for saving, auto-saving, and fetching faculty data.
 *   - Provide user feedback and validation using SweetAlert2.
 *   - Responsive and interactive UI with tabbed navigation and dynamic form sections.
 *
 * This component is central to the faculty entry workflow, ensuring robust data capture and a smooth user experience for faculty entry staff.
 */
...
const FacultyManagement = () => {
  ...
  //useEffect to handle rejected faculty
  useEffect(() => {
...
//useEffect to load auto-saved data
  useEffect(() => {
