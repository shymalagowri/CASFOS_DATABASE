 ...
 * FacultyView.jsx
 *
 * React component for Faculty Entry Staff to view and filter faculty records in the CASFOS system.
 *
 * Features:
 * - Displays a table of faculty records with fields: name, photograph, faculty type, mobile number, email, and year of allotment.
 * - Supports advanced filtering by faculty type, name, email, domains, and other criteria.
 * - Includes hierarchical domain selection (major and minor domains) from predefined options.
 * - Provides a detailed popup view for faculty records with formatted nested data and image previews.
 * - Offers responsive UI with sidebar navigation, styled filters, and a clear filter button.
 * - Integrates with backend APIs for dynamic data fetching based on filters.
 */
...
const FacultyView = () => { // Define FacultyView functional component
  ...
  // State for filter inputs and data
  ...
  const [areaOfExpertise, setAreaOfExpertise] = useState(""); // Area of expertise filter
  ...
  const [message, setMessage] = useState(""); // Error/no results message
  const [selectedFaculty, setSelectedFaculty] = useState(null); // Selected faculty for popup
  ...
  return (
    <div className="asset-view">
      ...
      {/* External stylesheets for Boxicons and Font Awesome */}
