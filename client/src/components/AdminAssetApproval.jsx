...
// This file contains the AssetApproval component, which is responsible for rendering the asset approval interface.
...
function AssetApproval() {
  ...
  const handleConditionChange = async (assetId, value) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          //("Sending to backend:", { condition: backendCondition, assetType: asset.assetType }); // Debug log
