      ...
      <div>
        ...
        <section id="sidebar">
          ...
          <ul className="side-menu top">
            <li className="active"><a href={`/superintendentdashboard?username=${encodeURIComponent(username)}`}><i className="bx bxs-dashboard" /><span className="text">Home</span></a></li>
            <li><a href={`/facultyverify?username=${encodeURIComponent(username)}`}><i className="bx bxs-doughnut-chart" /><span className="text">Faculty Verify</span></a></li>
