/**
 * principalfacultyview.jsx
 *
 * This React component provides the Principal with a comprehensive, filterable view of all faculty records
 * in the CASFOS Faculty Management System.
 *
 * Features:
 * - Dynamic filtering of faculty records by type, name, year of allotment, email, domain knowledge, area of expertise,
 *   institution, status, modules handled, major/minor domains, and mobile number.
 * - Fetches and displays filtered faculty data in a responsive, styled table.
 * - Allows viewing detailed faculty information in a popup, including nested and array fields, with image previews.
 * - Responsive UI with sidebar navigation, filter controls, styled tables, and modals for details.
 * - Integrates with backend APIs for data retrieval.
 * - Designed for Principal users to efficiently search, review, and inspect faculty records as part of the faculty management workflow.
 */
    ...
    const handleApplyFilter = async () => {
      try {
        const response = await axios.post(`http://${ip}:${port}/api/faculty/filterFaculties`, {
          ...
          email,
          domainKnowledge,
          areaOfExpertise: areaOfExpertise, // Corrected typo from original
          institution,
          status,
...
export default PrincipalFacultyView;