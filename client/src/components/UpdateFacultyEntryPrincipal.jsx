...
// Domain options (assuming it's defined elsewhere)
const domainOptions = {
  // ... (your original domainOptions object)
};
...
function UpdateFacultyEntryPrincipal() {
  ...
  // Initialize formattedFacultyData with fallback for missing facultyData
  const formattedFacultyData = facultyData
    ? {
        ...
        publications: Array.isArray(facultyData?.publications)
          ? facultyData.publications.map((pub) => ({
              ...pub,
              dateOfPublication: formatDate(pub.dateOfPublication),
            }))
          : [],
        coursesHandled: Array.isArray(facultyData?.coursesHandled)
          ? facultyData.coursesHandled.map((course) => ({
              ...course,
            }))
          : [],
        toursAttended: Array.isArray(facultyData?.toursAttended)
          ? facultyData.toursAttended.map((tour) => ({
              ...tour,
              startDate: formatDate(tour.startDate),
              endDate: formatDate(tour.endDate),
            }))
          : [],
        examiner: Array.isArray(facultyData?.examiner)
          ? facultyData.examiner.map((exam) => ({
              ...exam,
              date: formatDate(exam.date),
            }))
          : [],
        specialSessions: Array.isArray(facultyData?.specialSessions)
          ? facultyData.specialSessions.map((session) => ({
              ...session,
              date: formatDate(session.date),
            }))
          : [],
        modulesHandled: Array.isArray(facultyData?.modulesHandled)
          ? facultyData.modulesHandled
          : [],
      }
    : {
        name: "",
  ...
  const [facultyDetails, setFacultyDetails] = useState({
    ...
    modulesHandled: Array.isArray(formattedFacultyData?.modulesHandled)
      ? formattedFacultyData.modulesHandled
      : [],
    majorDomains: Array.isArray(formattedFacultyData?.majorDomains)
      ? formattedFacultyData.majorDomains
      : [],
    minorDomains: Array.isArray(formattedFacultyData?.minorDomains)
      ? formattedFacultyData.minorDomains
      : [],
    ...
    publications: Array.isArray(formattedFacultyData?.publications)
      ? formattedFacultyData.publications
      : [],
    educationDetails: Array.isArray(formattedFacultyData?.educationDetails)
      ? formattedFacultyData.educationDetails
      : [],
    coursesHandled: Array.isArray(formattedFacultyData?.coursesHandled)
      ? formattedFacultyData.coursesHandled
      : [],
    toursAttended: Array.isArray(formattedFacultyData?.toursAttended)
      ? formattedFacultyData.toursAttended
      : [],
    examiner: Array.isArray(formattedFacultyData?.examiner)
      ? formattedFacultyData.examiner
      : [],
    specialSessions: Array.isArray(formattedFacultyData?.specialSessions)
      ? formattedFacultyData.specialSessions
      : [],
    institution: formattedFacultyData?.institution || "",
    otherResponsibilities: Array.isArray(formattedFacultyData?.otherResponsibilities)
      ? formattedFacultyData.otherResponsibilities
      : [],
  ...
  const [domainExpertise, setDomainExpertise] = useState(() => {
    if (Array.isArray(formattedFacultyData?.majorDomains) && formattedFacultyData.majorDomains.length > 0) {
      return formattedFacultyData.majorDomains.map((major) => ({
        major,
        minors: Array.isArray(formattedFacultyData?.minorDomains)
          ? formattedFacultyData.minorDomains.filter((minor) => domainOptions[major]?.includes(minor))
          : [],
      }));
    }
    return [{ major: "", minors: [] }];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      arrayFields.forEach((field) => {
        if (Array.isArray(updatedFacultyDetails[field]) && updatedFacultyDetails[field].length > 0) {
                  ...
                  {facultyType === "internal" && (
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      <label>Photograph (less than 500KB):</label>
                      <input
                        type="file"
                        name="photograph"
                        accept="image/*"
                      ...
                      {!previewImage && (
                        <p style={{ color: "#555", fontSize: "14px" }}>No photograph uploaded.</p>
                      )}
                      <label>Status:</label>
                      <select
                        name="status"
                      ...
                      {Array.isArray(facultyDetails.educationDetails) &&
                      ...
                      {Array.isArray(facultyDetails.coursesHandled) &&
                      ...
                      {Array.isArray(facultyDetails.toursAttended) &&
                      ...
                      {Array.isArray(facultyDetails.examiner) &&
                      ...
                      {Array.isArray(facultyDetails.specialSessions) &&
                      ...
                      {Array.isArray(facultyDetails.modulesHandled) &&
                      ...
                      {Array.isArray(facultyDetails.otherResponsibilities) &&
